...
struct PrivacyPolicyView: View {
	...
	private var introView: some View {
		VStack(alignment: .leading, spacing: paragraphSpacing) {
			...
			Text("Matthew Lee built the COVID-19 Stats UK app as a Free app. This SERVICE is provided by Matthew Lee at no cost and is intended for use as is.")
			...
			Text("The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at COVID-19 Stats UK unless otherwise defined in this Privacy Policy.")
			
		}
	}
	
	private var informationCollectionAndUseView: some View {
		VStack(alignment: .leading, spacing: paragraphSpacing) {
	...
	private var logDataView: some View {
		VStack(alignment: .leading, spacing: paragraphSpacing) {
	...
	private var cookiesView: some View {
		VStack(alignment: .leading, spacing: paragraphSpacing) {
	...
	private var serviceProvidersView: some View {
		VStack(alignment: .leading, spacing: paragraphSpacing) {
	...
	private var linksToOtherSitesView: some View {
		VStack(alignment: .leading, spacing: paragraphSpacing) {
	...
	private var childrensPrivacyView: some View {
		VStack(alignment: .leading, spacing: paragraphSpacing) {
	...
	private var changesToThisPrivacyPolicyView: some View {
		VStack(alignment: .leading, spacing: paragraphSpacing) {
			...
			Text("This policy is effective as of 2020-12-31")
		}
	}
	...
	private var contactUsView: some View {
		VStack(alignment: .leading, spacing: paragraphSpacing) {
			...
			Text("If you have any questions or suggestions about my Privacy Policy, do not hesitate to contact me at covid19statsuk@gmail.com.")
			
			Text("This privacy policy page was created at https://privacypolicytemplate.net and modified/generated by https://app-privacy-policy-generator.nisrulz.com.")
		}
	}
	...
	var body: some View {
		ScrollView {
			VStack(alignment: .leading, spacing: sectionSpacing) {
				...
				informationCollectionAndUseView
				...
				linksToOtherSitesView
				
				childrensPrivacyView
				
				changesToThisPrivacyPolicyView
